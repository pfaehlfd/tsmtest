...
class BreadcrumbItemArrow {
	...
	public BreadcrumbItemArrow(final BreadcrumbItem parent,
		...
		// images
		rightImage = ResourceManager.getImgRight();
		leftImage = ResourceManager.getImgLeft();
		downImage = ResourceManager.getImgDown();

		imageElement = new Label(parentContainer, SWT.NONE);
		imageElement.setImage(getArrowImage(false));
		imageElement
				.setToolTipText(Messages.BreadcrumbItemArrow_0);
