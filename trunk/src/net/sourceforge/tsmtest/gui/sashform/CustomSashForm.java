 ...
 *******************************************************************************/
package net.sourceforge.tsmtest.gui.sashform;
...
public class CustomSashForm extends Composite {
    ...
    CustomComposite createSash() {
	CustomComposite sash = new CustomComposite(this, sashStyle);
     ...
     * <code>{@link #getStyle()}</code> and test if the SWT.RIGHT_TO_LEFT or
     * SWT.LEFT_TO_RIGHT bits are set.
     * </p>
     * 
	...
	CustomComposite sash = (CustomComposite) event.widget;
	int sashIndex = -1;
     ...
     * 
     * <p>
     * Since 3.7, this method can also be called with SWT.RIGHT_TO_LEFT or
     * SWT.LEFT_TO_RIGHT to change the bidi orientation of the SashForm.
     * </p>
     * 
     * @param orientation
     *            SWT.HORIZONTAL or SWT.VERTICAL, SWT.RIGHT_TO_LEFT or
     *            SWT.LEFT_TO_RIGHT
     * 
     ...
     *                is not SWT.HORIZONTAL or SWT.VERTICAL, SWT.RIGHT_TO_LEFT
	...
	for (int i = 0; i < cArray.length; i++) {
	    ...
	    ((CustomSashFormData) data).weight = (((long) weights[i] << 16)
		    + total - 1)
		    / total;
	}
